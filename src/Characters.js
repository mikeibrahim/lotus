	...
	static getCharacters() {
		return [
			...
			},
			{
				...
				name: 'Tulip',
				color: '#ffc285',
				description: '[Passive] Pushes enemies away within a radius. Upgrades may increase the radius and amount of push.',
			...
			},
			{
				...
				name: 'Poppy',
				color: '#ff8ff2',
				description: '[Passive] Shrinks and slows enemies within a radius. Upgrades may increase the radius and amount of slow.',
